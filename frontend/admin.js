...
function add_new_post() {
    ...
    data = `title=${new_post_form["title"].value}&password=${new_post_form["content"].value}`
    var request = {
        method: 'POST',
...
function update_post(){
    ...
    data = `title=${update_post_form["title"].value}&password=${update_post_form["content"].value}`
    var request = {
        method: 'PUT',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8' },
        body: data
